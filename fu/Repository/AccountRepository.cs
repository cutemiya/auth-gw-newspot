...
public class AccountRepository : IAccountRepository
{
    ...
    public async Task<DbAccount> GetOtherUser(int accountId)
    {
        return await _dapperContext.Connection.QueryFirstAsync<DbAccount>($@"select * from accounts where id = {accountId}");
    }
