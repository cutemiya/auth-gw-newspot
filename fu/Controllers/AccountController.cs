...
public class AccountController: BaseController
{
    ...
    [HttpGet("other-user/{accountId}")]
    public async Task<IActionResult> GetOtherUser([FromRoute] int accountId)
    {
        return Ok(await _accountService.GetOtherUser(accountId));
    }
}